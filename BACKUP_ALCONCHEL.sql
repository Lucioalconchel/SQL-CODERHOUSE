/*
    Los datos proporcionados en este backup pertenecen a las tablas
        cuenta
        descuento
        pago
        plataforma
        ...
        tarjeta
        usuario
    Decidi excluir las tablas:
        log_pay
        log_price
    Ya que como tal no tienen un insert directo, si no que son tablas creadas
    a base del uso de los triggers.
*/
...
-- Dump completed on 2023-01-30 19:59:27
